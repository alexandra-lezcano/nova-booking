class EstatesController < ApplicationController
  ...
  def estate_params
    params.require(:estate).permit(:name, :address, :city_id, :owner_id, images: [], rooms_attributes: %i[id estate_id description capacity price status room_type quantity])
  end
end
